...
/*****************************************************************************
 * HTTPServer: implementa um servidor HTTP básico, referente ao EP1 de MAC448.
 *             Também contém um servidor de mensagens e um atualizados de
 *             arquivos que mantém os dados persistentes no HD.
 ****************************************************************************/
public class HTTPServer {
	...
	public static void help() {
		System.out.println("Usage: java -jar HTTPServer.jar <http port> <msg server port>");
		System.out.println("  http port: the port in which to run the HTTP server.");
	 ...
	 ************************************************************************/
	public HTTPServer(int port, int ms_port, String filename) {
	...
	private void run() {
		...
		try {
			...
			System.err.println("Error in HTTPServer.run(): "
					+ e.getMessage());
		}
	}
	...
	/*************************************************************************
	 * HTTPHeader: envia cabeçalhos http para o stream de saída indicado.
	 ************************************************************************/
	private void HTTPHeader(DataOutputStream os,
							String type,
							int length) throws Exception {
		os.writeBytes("HTTP/1.0 200 Document Follows\r\n");
	...
	public class FileUpdater implements Runnable {
		 ...
		 ********************************************************************/
		public FileUpdater(String fileName, HTTPServer server, int sleepTime) {
